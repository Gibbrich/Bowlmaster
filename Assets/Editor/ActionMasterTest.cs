...
public class ActionMasterTest
{
    ...
    {
        Assert.AreEqual(ActionMaster.Action.END_TURN, ActionMaster.NexAction(new List<int>{10}));
    }

    [Test]
    public void T02Bowl8ReturnsTidy()
    {
        Assert.AreEqual(ActionMaster.Action.TIDY, ActionMaster.NexAction(new List<int>{8}));
    }
    ...
    public void T04Bowl28SpareReturnsEndTurn()
    {
        ...
        Assert.AreEqual(ActionMaster.Action.END_TURN, ActionMaster.NexAction(pinFalls));
    }
    ...
    public void T05CheckResetAtStrikeInLastFrame()
    {
        ...
        Assert.AreEqual(ActionMaster.Action.RESET, ActionMaster.NexAction(pinFalls));
    }
    ...
    public void T07YouTubeRollsEndInEndGame()
    {
        ...
        Assert.AreEqual(ActionMaster.Action.END_GAME, ActionMaster.NexAction(pinFalls));
    }
    ...
    public void T09Bowl20AfterStrikeReturnsTidy()
    {
        ...
        Assert.AreEqual(ActionMaster.Action.TIDY, ActionMaster.NexAction(pinFalls));
    }
